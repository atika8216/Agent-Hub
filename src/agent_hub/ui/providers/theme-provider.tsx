...
interface ThemeContextValue {
  ...
  /**
   * True when AGENT_HUB_LEGACY_UI is set on the server. Consumers should hide
...
const STORAGE_KEY = "agent_hub.theme";
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  // Fetch the server-side AGENT_HUB_LEGACY_UI flag plus the resolved Phase
