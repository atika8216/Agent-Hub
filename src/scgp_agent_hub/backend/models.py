"""Pydantic request/response models for the SCGP Agent Hub API."""
...
class AppConfigOut(BaseModel):
    legacy_ui: bool = Field(
        ...
        description="When true, ThemeProvider locks the UI to the legacy "
                    ...
                    "setting the SCGP_LEGACY_UI=1 environment variable on "
